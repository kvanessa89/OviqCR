...
window.OVIQ_SEED = (() => {
  ...
  const workers = [
    ...
    { id: 'w2', name: 'Luis Miguel Araya',   role: 'Técnico Senior',       email: 'luis.araya@oviq.com',    phone: '+506 8822-4455', status: 'Activo', workType: 'Por contrato', initials: 'LA', color: '#10B981' },
    { id: 'w3', name: 'Sofía Campos',        role: 'Coordinadora',         email: 'sofia.campos@oviq.com',  phone: '+506 8833-6677', status: 'Activo', workType: 'Por horas',    initials: 'SC', color: '#EC4899' },
    ...
    { id: 'w5', name: 'Paula Chaves',        role: 'Analista',             email: 'paula.ch@oviq.com',      phone: '+506 8855-1122', status: 'Activo', workType: 'Por contrato', initials: 'PC', color: '#8B5CF6' },
  ...
  ticketPlan.forEach(plan => {
    plan.items.forEach((it, i) => {
      ...
      tickets.push({
        ...
        comments: [
          { id: 'cm' + tid + '1', author: worker.name, initials: worker.initials, text: 'Trabajando en esta tarea.', date: d(-3), kind: 'worker' },
        ],
      });
    });
  });
